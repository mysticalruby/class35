// I want help but outside of class I am shy to aks so here is my message.
...
function preload()
{
  ...
  Happy= loadAnimation("eat_0.png","eat_1.png","eat_2.png","eat_3.png","eat_4.png","eat_5.png");
...
if(mouseX && mouseY.isTouching(button)){
  remove_button();
  remove_rope();
} 
